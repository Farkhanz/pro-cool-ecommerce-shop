...
<head>
	...
	<title>PRO COOL | REGISTER PAGE</title>
		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					<div class="brand">
						<img src="../img/logo-ac.jpg" alt="bootstrap 4 login page">
					</div>
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title">Register</h4>
							<form method="post" action="../koneksi/simpan_regist.php">
								...
								<div class="form-group">
									...
									<input id="telephone" type="text" class="form-control" name="telephone" autocomplete="off">
									<div class="invalid-feedback">
