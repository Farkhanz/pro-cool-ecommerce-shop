...
<html>
  <head>
    ...
    <title>PRO COOL | NOTA PEMBELIAN</title>
...
<table class="table table-bordered">
    ...
    <tbody>
        <?php $nomor=1; ?>
        <?php $culik=$conn->query("SELECT * FROM pembelian_barang WHERE id_pembelian_barang='$_GET[id]'"); ?>
...
<div class="row"> 
    <div class="col-md-12"> 
            <div class="alert alert-info">
                <p> Silahkan melakukan Pembayaran Rp. <?php echo number_format($info['total_harga']);?> <br>
                <strong> BANK BNI 223.486.993 A.N PRO COOL</strong>
                </p>
            </div>
    </div>
</div>
      ...
      <div class="bg-light px-4 py-3">
        <div class="row align-items-center text-center">
          <div class="col-md-12 mb-9 mb-md-0 text-md-right"><a class="btn btn-link p-0 text-dark btn-sm" href="pembayaran.php?id_pembelian=<?php echo $info['id_pembelian'] ?>">Lanjutkan Pembayaran</a></div>
        </div>
      </div>
